...
```groovy
testImplementation("com.github.seregamorph:spring-test-smart-context:1.0")
```
...
In case you need it, check the 0.15 [README](https://github.com/seregamorph/spring-test-smart-context/blob/v0.15/README.md).
</details>
